      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              <span className="font-semibold">Wie erfassen wir Ihre Daten?</span>
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              <span className="font-semibold">Wofür nutzen wir Ihre Daten?</span>
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              <span className="font-semibold">Welche Rechte haben Sie bezüglich Ihrer Daten?</span>
            </p>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">Externes Hosting</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            ...
            <div className="bg-gray-50 p-4 rounded-lg text-gray-700 mb-4">
              <p className="font-semibold">Damm Grill</p>
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">Speicherdauer</h3>
            <p className="text-gray-700 leading-relaxed">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h3>
            <p className="text-gray-700 leading-relaxed">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">Beschwerderecht bei der zuständigen Aufsichtsbehörde</h3>
            <p className="text-gray-700 leading-relaxed">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">Recht auf Datenübertragbarkeit</h3>
            <p className="text-gray-700 leading-relaxed">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">Auskunft, Löschung und Berichtigung</h3>
            <p className="text-gray-700 leading-relaxed">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">Recht auf Einschränkung der Verarbeitung</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">Kontaktformular</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">Google Maps</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              Google Maps lädt Ihr Browser die benötigten Web Fonts in ihren Browsercache, um Texte 
